...
class KNearestNeighbors(ClassifierMixin, BaseEstimator):
    ...
    def predict(self, X):
        ...
        for i, inds in enumerate(nearest_indices):
            nearest_labels = self.y_[inds]
...
class MonthlySplit(BaseCrossValidator):
    ...
    def get_n_splits(self, X, y=None, groups=None):
        ...
        months = sorted(list(set([(d.year, d.month) for d in time_data])))
    ...
    def split(self, X, y, groups=None):
        ...
        unique_months = sorted(list(
            set([(d.year, d.month) for d in time_data]))
        )
        for i in range(n_splits):
            ...
            idx_train = []
            idx_test = []
            for idx, date in enumerate(time_data.tolist()):
